...
const LESSONS = [
  ...
  { id:3, phase:1, title:"Clothes", sub:"Naming items · Getting dressed", aud:"kids",
    phrases:[
      ...
      {hu:"Vedd fel a kabátot!",pr:"Vedd fel o ko-bá-tot",en:"Put on the coat!"},
  ...
  { id:5, phase:1, title:"Weather & Choosing", sub:"Hot · Cold · Raining", aud:"kids",
    phrases:[
      ...
      {hu:"Melyiket vegyük fel?",pr:"Me-yyi-ket ve-dyük fel",en:"Which one?"},
  ...
  { id:6, phase:1, title:"Planning the Day", sub:"What's the plan · Deciding", aud:"wife",
    phrases:[
      ...
      {hu:"Mi a terv mára?",pr:"Mi o terv má-ro",en:"Plan for today?"},
  ...
  { id:7, phase:2, title:"Going Somewhere", sub:"Let's go · Crossing roads", aud:"kids",
    phrases:[
      ...
      {hu:"A parkba megyünk.",pr:"A park-ba me-dyünk",en:"Going to the park."},
      {hu:"A boltba megyünk.",pr:"A bolt-ba me-dyünk",en:"Going to the shop."},
  ...
  { id:11, phase:2, title:"School Run", sub:"Drop-off · Pickup · Feelings", aud:"kids",
    phrases:[
      {hu:"Iskolába megyünk.",pr:"Ish-ko-lá-ba me-dyünk",en:"Going to school."},
  ...
  { id:12, phase:2, title:"Meeting People", sub:"Greetings · How are you", aud:"kids",
    phrases:[
      {hu:"Nagyihoz megyünk.",pr:"No-dyi-hoz me-dyünk",en:"Going to grandma's."},
  ...
  { id:18, phase:3, title:"Boundaries", sub:"Stop · Not allowed · Calm", aud:"kids",
    phrases:[
      ...
      {hu:"Ez nem szabad.",pr:"Ez nem so-bod",en:"Not allowed."},
      ...
      {hu:"Gyere, megbeszéljük.",pr:"Dye-reh, meg-be-sél-yük",en:"Let's talk about it."},
  ...
  { id:21, phase:4, title:"What Do You Want?", sub:"Offering · Refusing", aud:"kids",
    phrases:[
      ...
      {hu:"Nem kérek, köszönöm.",pr:"Nem ké-rek, kö-sö-nöm",en:"No thanks."},
  ...
  { id:23, phase:4, title:"Mealtimes", sub:"Sit · Eat · Thank you", aud:"kids",
    phrases:[
      ...
      {hu:"Köszönöm az ételt.",pr:"Kö-sö-nöm oz é-telt",en:"Thanks for food."},
  ...
  { id:30, phase:6, title:"Bath Time", sub:"Wash · Rinse · Dry", aud:"kids",
    phrases:[
      ...
      {hu:"Szállj be!",pr:"Sáyj be",en:"Get in!"},
      {hu:"Mosd meg a kezed!",pr:"Moshd meg o ke-zed",en:"Wash hands!"},
      {hu:"Csukd be a szemed!",pr:"Chukd be o se-med",en:"Close eyes!"},
  ...
  { id:31, phase:6, title:"Bedtime", sub:"Pyjamas · Tuck in · Goodnight", aud:"kids",
    phrases:[
      ...
      {hu:"Vedd fel a pizsamád!",pr:"Vedd fel o pi-zho-mád",en:"Put on pyjamas!"},
  ...
  { id:32, phase:7, title:"Their Day", sub:"What did you do · Best part", aud:"kids",
    phrases:[
      ...
      {hu:"Mi volt a legjobb?",pr:"Mi volt o leg-yobb",en:"Best part?"},
