...
const LESSONS = [
  ...
  { id:15, trackId:"bath-time", band:"B1", seq:1, rung:4,
    ...
    phrases:[
      ...
      {hu:"Hol van a kacsa?",      pr:"hol von o KO-cho", en:"Where is the duck?"},
      {hu:"Piszkos a kezed?",      pr:"PIS-kosh o KE-zed", en:"Is your hand dirty?"},
    ],
    tip:"Vagy means 'are' (talking to you); van means 'is' — van is what you use when asking where something is." },
  ...
  { id:20, trackId:"bath-time", band:"B1", seq:6, rung:5,
    ...
    phrases:[
      ...
      {hu:"Nagyon ügyes vagy, kész vagy!", pr:"NO-dyon Ü-dyesh vody kés vody", en:"You're very clever, you're ready!"},
      ...
      {hu:"A víz meleg, ügyes vagy!",   pr:"o víz ME-leg Ü-dyesh vody",    en:"The water's warm, you're clever!"},
      {hu:"Nem piszkos, ügyes vagy!",   pr:"nem PIS-kosh Ü-dyesh vody",    en:"You're not dirty, you're clever!"},
      {hu:"Már nem hideg a kád, meleg!", pr:"már nem HI-deg o kád ME-leg", en:"The bath's not cold anymore, it's warm!"},
      {hu:"A törölköző tiszta, ügyes vagy!", pr:"o tö-röl-kö-ző TIS-to Ü-dyesh vody", en:"The towel's clean, you're clever!"},
    ],
  ...
  { id:24, trackId:"bath-time", band:"B2", seq:4, rung:6,
    ...
    phrases:[
      ...
      {hu:"Mosd meg a hajad, utoljára öblítsd le!",  pr:"mosd meg o HO-yod U-tol-yá-ro ÖB-lítsd le", en:"Wash your hair, and last rinse it off!"},
  ...
  { id:25, trackId:"bath-time", band:"B2", seq:5, rung:6,
    ...
    phrases:[
      ...
      {hu:"Tudom, hogy piszkos vagy, de mosd meg!",     pr:"TU-dom hody PIS-kosh vody de mosd meg", en:"I know you're dirty, but wash it!"},
  ...
  { id:26, trackId:"bath-time", band:"C1", seq:1, rung:6,
    ...
    types:["fill_typed","sentence_builder"],
    phrases:[
      {hu:"Gyere már, kacsám, kész a víz!",        pr:"DYE-re már KO-chám kés o víz",     en:"Come on, my little duck, the water's ready!"},
  ...
  { id:28, trackId:"bath-time", band:"C1", seq:3, rung:7,
    ...
    phrases:[
      ...
      {hu:"Utoljára leöblítettem a fejed, és minden kész volt.", pr:"U-tol-yá-ro le-ÖB-lí-tet-tem o FE-yed és MIN-den kés volt", en:"Last I rinsed your head, and everything was done."},
